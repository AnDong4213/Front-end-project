...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"a"}[chunkId]||chunkId) + ".bundle2.js";
...
// module
exports.push([module.i, "body{font-size:30px}.src-css-common_bigBox_27sNb{border:2px solid #000}", ""]);
...
module.exports = function(css) {
  ...
  if (window.innerWidth >= 768) {
    return css.replace('pink', 'lightgreen')
  } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_base_less__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_base_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__css_base_less__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_common_css__ = __webpack_require__(9);
...
pp[0].className = __WEBPACK_IMPORTED_MODULE_0__css_base_css___default.a.box;
pp[1].className = __WEBPACK_IMPORTED_MODULE_1__css_base_less___default.a.less;

__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 10)).then(function(para) {
  // console.log(para);
...
// module
exports.push([module.i, "html{background-color:pink}.src-css-base_box_REzyU{height:200px;width:200px;border-radius:4px;background-color:pink}", ""]);
...
module.exports = {"less":"src-css-base_less_fOO5K"};
