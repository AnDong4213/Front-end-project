...
{
  console.log("kkkkk", new Array(1, 2, "yy"));
  ...
  class Child extends Parent {
    ...
    yy() {
      console.log("yy");
      Child.func(); // 在里面调用  自己没有静态，就去找父的静态方法
    }
    /* static func() {
			console.log('自己的静态承哦...');
		} */
    ...
    func() {
      console.log("这不是静态方法-子qqqqqqqqqqqq...");
...

{
  ...
  class A {
    ...
    hehe() {
      // console.log(this) // 在子类普通方法中通过super调用父类的方法时，方法内部的this指向当前的子类实例。
      console.log("我是呵呵...");
    }
    hihi() {
      console.log("hihi");
